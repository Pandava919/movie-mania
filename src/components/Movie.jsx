...
const Movie = ({ poster, title, year }) => {
    ...
    return (
        <div className=' h-60 sm:h-60 w-60 flex flex-col items-center rounded-lg bg-red-700'>
            ...
            <h2 > <span className='text-white text-ellipsis text-sm font-light'>{title}</span></h2>
